    ...
    <div class=centered >
        ...
        <!-- Full-width images with number and caption text -->
          <div class="mySlides ">
            ...
            <div class="mySlides ">
                <center><h1 class="textQuest">Apakah instruksi ini sudah cukup jelas dan dapat dipahami? Jika ada hal yang kurang jelas, silakan bertanya kepada peneliti.</h1> <br> <br>
                        <h1 class=textQuest >Tekan mouse untuk melanjutkan. (dengan menekan tombol mouse, berarti anda telah bersedia untuk menjadi partisipan dalam penelitian ini)</h1> <br><br>
...
function clickButton(){
  window.location = "/tester/control/pretest/focus/3/1";
}
