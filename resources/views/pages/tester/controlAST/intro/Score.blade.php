            ...
            function timer() {
                ...
                // window.location = "/tester/question";
                    ...
                    if(seri >3){
                        ...
                        window.location = "/tester/control/intro/question/1/1"

                    }
                    else{
                        window.location = "/tester/control/intro/focus/"+seri +"/"+iterasi;
                    }
                }
...
<body style ="background-color: #d2d6de" > 
        <div class="centered">
            <H1 style="font-size:50px" >Skor Anda : {{$detik}} detik, {{$benar}} benar, {{$salah}} salah</h1>
        </div>
</body>
