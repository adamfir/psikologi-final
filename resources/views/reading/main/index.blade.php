    ...
    <div class="d-flex justify-content-center align-items-center lg-6 md-6 mb-6" style="height:92vh">
        ...
        <div>
            ...
            {{-- <div class="animateTitle">
                <h1>READING SPAN TASK</h1>
                <h5>Kelompok Kontrol</h5>
            </div>
            <div class="animateSubtitle">
                <h1>LATIHAN</h1>
            </div>
            <div class="instruksiLatihan">
                <h3>Dalam bagian latihan ini, soal latihan terdiri dari 2 item seri kata. <br>
                Seri kata benda akan disajikan sekali saja pada layar monitor tanpa adanya pengulangan. <br>
                Cobalah untuk mengingat kata benda yang disajikan. </h3>
            </div> --}}
        </div>
    </div>
</div>
