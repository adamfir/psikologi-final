...
<div class="container">
    ...
    <div class="d-flex justify-content-center align-items-center lg-6 md-6 mb-6" style="height:92vh">
        <div style="text-align:center">
            <div class="animate1">
                <h3>Dalam Bahasa Inggris bayi kuda disebut foal.</h3>
            </div>
            <div class="animate2">
                <h3>Bayi kuda jantan disebut colt.</h3>
            </div>
            <div class="animate3">
                <h3>Bayi kuda betina disebt filly.</h3>
            </div>
            <div class="animate4">
                <h3>Ketika berumur  setahun kuda disebut yearling.</h3>
            </div>
