        ...
        var start = Date.now()
            function timer() {
                ...
                // window.location = "/tester/question";
                    ...
                    if(seri >3){
                        window.location = "/tester/control/main/instruksi";
                    }else{
                        window.location = "/tester/control/latihan/main/"+seri +"/"+iterasi;
                    }
...
<body style ="background-color: #d2d6de" > 
        ...
        <img src={{$pict}} style="display:block;  width:100%; height:100%; object-fit: cover;" >
