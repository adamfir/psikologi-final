<head>
    ...
    <script>
        ...
        var random = [[], [],[[9,7,5,3], [5,3,2,6]], [[2,5,9,8,1], [7,5,9,1,2]], [[4,6,2,3,1,5], [7,6,8,5,9,4]], [[4,9,6,8,5,2,1], [3,7,9,5,2,1,8]], [[5,2,3,7,8,9,6,1], [2,7,4,6,1,3,9,8]]];
        var totalSeconds = 0;
        var total = 0;
    ...
    function myFunction(id) {
        ...
        if(jawaban.length == random[seri-1][iterasi-1].length){
            ...
            detik = 10 - total + detikBefore;
            console.log(detik);
            window.location = "/tester/main/focus/"+seri +"/"+iterasi + "/" + <?= $id ?> + "/" + <?= $id1 ?> + "/" + id2 + "/" + detik;
        }
    }
