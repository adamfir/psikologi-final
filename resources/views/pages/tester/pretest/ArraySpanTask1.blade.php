<head>
    ...
    <script>
        ...
        var random = [[], [], [[1,5,9,2], [3,9,2,1]], [[4,9,2,8,1], [6,8,9,1,3]], [[3,1,2,6,7,4], [7,9,8,4,3,6]], [[1,7,5,2,8,9,3], [7,5,3,1,9,6,4]], [[4,2,1,9,5,3,6,8], [7,1,3,9,4,2,8,5]]]
        var totalSeconds = 0;
        var total = 0;
    ...
    function myFunction(id) {
        ...
        if(jawaban.length == random[seri-1][iterasi-1].length){
            ...
            total = detikBefore + total;
            window.location = "/tester/pretest/arrayQuest2/"+seri +"/"+iterasi + "/"+ <?= $id ?> + "/" + id1 + "/" + total ;
        }
    }
